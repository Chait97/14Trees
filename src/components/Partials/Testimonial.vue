<template>
    ...
    <div class="container py-24 mx-auto">
        <div class="grid grid-cols-8">
            <div v-if="hasImgs" class="col-span-5 flex justify-end">
                <!-- <span class="w-1 bg-green-300"></span> -->
                <div class="ml-4 p-16 w-10/12">
                    <VueSlickCarousel :arrows="true" :dots="true">
                        <div v-for="(pic, index) in picturesToDisplay" :key="index">
                            <g-image :src="imgSrc(pic)" class="h-full object-contain object-right"/>
                        </div>
                    </VueSlickCarousel>
                </div>
                <span class="w-1 bg-green-300"></span>
            </div>
            <div :class="{ 'col-span-3' : hasImgs, 'col-span-8' : !hasImgs }">
